        ...
        children: [
          ...
          ..._recognitions.map((re) {
            if (re == null) {
              ...
              Cn.add(re.className ?? '');
              Sc.add((re.score * 100).toStringAsFixed(0).toString());
            }
            Color usedColor;
            if (boxesColor == null) {
              //change colors for each label
              usedColor = Color(0xFFA6E247);
            } else {
              ...
              children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(
                          ...
                          Text((i+1).toString() + ': 전면 ' + (Cn[i]) + ' (' + (Sc[i])+ "%" + ')' ,
                            style: TextStyle(
                              fontFamily: 'Nanum Round',
                              fontSize: 14,
                              fontWeight: FontWeight.w600,
                ...
                Positioned(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('- 총 ' + index.toString() + '개의 파손이 탐지되었습니다.',
                        style: TextStyle(
                          fontFamily: 'Nanum Round',
                          fontSize: 18,
                          fontWeight: FontWeight.w600,
