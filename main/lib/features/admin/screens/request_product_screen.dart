...
class RequestProductScreen extends StatefulWidget {
  static const String routeName = '/request-product';
  const RequestProductScreen({Key? key}) : super(key: key);
...
class _RequestProductScreenState extends State<RequestProductScreen> {
  ...
  final _requestProductFormKey = GlobalKey<FormState>();
  @override
  void dispose() {
  ...
  List<String> productCategories = ['물건요청'];

  void sellProduct() {
    final user = Provider.of<UserProvider>(context, listen: false).user;

    if (_requestProductFormKey.currentState!.validate() && images.isNotEmpty) {
